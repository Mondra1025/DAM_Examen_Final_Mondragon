...
import com.example.dam_examen_final_mondragon.databinding.FragmentItemBinding;
...
public class MyNotaRecyclerViewAdapter extends RecyclerView.Adapter<MyNotaRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView=view;
            tvTitulo=view.findViewById(R.id.txtViewTitulo);
            tvContenido=view.findViewById(R.id.txtViewContenido);
